  ...
  %  end
    ...
    methods
        ...
        function [U,F,A,Fa,Fb,Fc] = speed1(obj,argu1,argu2,t,e1,e2)
            ...
            Fu1 = obj.ko*(Fa(2,1) + Fb(2,1) + Fc(2,1)) - obj.kd * obj.U(2,t_r);        %娉曞?戝姏
            if (t_r>1)
                theta_i = atan2(obj.U(1,t_r),obj.U(2,t_r));                 %鑸?戣1
                theta_i_old = atan2(obj.U(1,t_r_old),obj.U(2,t_r_old));     %鑸?戣2
            else
                theta_i = atan(obj.U(1,t_r)/obj.U(2,t_r));
                theta_i_old = 0;
            end

            omega_i = (theta_i-theta_i_old)/obj.q;                   %瑙掗€熷害
            u_theta = -ktheta*(theta_i-0)-komega*omega_i;            %鍔涚煩
            Fu2 =-(u_theta/obj.I)*cos(theta_i);                      %鍔涚煩杞负娉曞?戝姏鐨勫舰寮?
